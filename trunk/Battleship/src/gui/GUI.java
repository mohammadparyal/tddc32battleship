...
public class GUI extends JFrame {
	...
	{
		mouseOverCell = cell;
//		System.out.println("cell "+mouseOverCell.getXID()+','+mouseOverCell.getYID());
	}
	
	public void placeShip()
	{
		if(ship!=null)
			mouseOverCell.getGrid().swapColor(ship.getLength(), 
					mouseOverCell.getXID(), mouseOverCell.getYID());		
	}
